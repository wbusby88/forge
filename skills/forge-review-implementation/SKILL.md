...
3. `hardening`: dispatch three reviewer roles to critique the aligned implementation for residual defect risk
...
Answer the critique directly from artifacts, code, tests, evidence, and the three reviewer outputs. Do not ask the user to perform discovery.
