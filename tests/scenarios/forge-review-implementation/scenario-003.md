# Scenario 003 - Approved Improvements Route to Iteration
...
- writes `## Implementation Review Decision - <YYYY-MM-DD>` to `plan.md` with selected sets, decision ledger, and a `forge-iterate` handoff classification including hard triggers and weighted risk score
