# Scenario 007 - Scope-Changing Accepted Improvements Route to Iterate

## Setup

- implementation review completed
- user approves the explicit proposed improvement sets for actionable findings
- accepted fixes change approved intent, acceptance criteria, task graph, or major iteration risk enough that direct resume would be unsafe
