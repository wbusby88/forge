...
- reads `todo.json`, `requirements.md` when present, `plan.md`, `research.md`, and `implementation-review.md`
...
- includes requirement-by-requirement coverage in `verification.md` when `requirements.md` exists
